...
naiveBayes <- setRefClass("naiveBayes",
       ...
       methods = list(
                    fit = function(X, y)
                    {
                         ...
                         prob_neg = prob_sentiments[1,]$n/sum(prob_sentiments$n)
                         prob_neu = prob_sentiments[2,]$n/sum(prob_sentiments$n)
                         prob_pos = prob_sentiments[3,]$n/sum(prob_sentiments$n)
