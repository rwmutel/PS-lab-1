        ...
        # (binary classification task)
                    fit = function(X, y)
                    {
                         ...
                         for(i in 1:nrow(fdict)){
                           ...
                           i_total = fdict[i, "total"]

                           if (length(i_pos) == 0){
                              fdict[i,]$prob_positive <<- 1 / i_total
                           }
                           else{
                              fdict[i,]$prob_positive <<- i_pos / i_total
                           }
                           if (length(i_neu) == 0){
                              fdict[i,]$prob_neutral <<- 1 / i_total
                           }
                           else{
                              fdict[i,]$prob_neutral <<- i_neu / i_total
                           }
                           if (length(i_neg) == 0){
                              fdict[i,]$prob_negative <<- 1 / i_total
                           }
                           else{
                              fdict[i,]$prob_negative <<- i_neg / i_total
                           }
