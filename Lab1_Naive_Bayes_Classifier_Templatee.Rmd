...
accuracy of the similarity search algorithm.
...
and we can use the **bag of words** technique. Its main pros are
(usually) relatively good **accuracy** and high **speed**. Its con is
that in specific cases word order and word combinations may be **more
useful** than single word bag of words approach. Also, no model works
well if it was trained on invalid data which does not illustrate real
conditions.
